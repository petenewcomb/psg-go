...
func ExamplePool_Cancel() {
	...
	firstRunner := psg.NewLauncher0(psgfn.TaskFunc0(func(ctx context.Context) error {
	...
	secondRunner := psg.NewLauncher0(psgfn.TaskFunc0(func(ctx context.Context) error {
